...
Vou inserir graficos nessa parte... mas por enquanto vou deixar o mermaid pra ilustrar
...
Além da entrega escrita, quero um vídeo curto — um pitch, como se vocês estivessem apresentando a solução para a liderança da empresa e precisassem convencer de uma decisão.
 
O vídeo precisa ter:
•	A arquitetura e os diagramas — mostrem o fluxo na tela, não só falem dele.
•	A base e o problema de negócio — rápido: o que é e por que importa.
•	A demonstração funcionando nas duas plataformas — pode ser tela gravada do Databricks e do Snowflake.
•	A escolha — qual plataforma vocês recomendam e por quê.
•	Os custos — o modelo de cobrança de cada uma e a estimativa para o seu caso. É o número que justifica a recomendação.
 
Duração sugerida: 5 a 8 minutos.
 
O grupo pode apresentar em gravação ou utilizar uma LLM para geração.
